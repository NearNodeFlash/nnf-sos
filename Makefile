...
IMAGE_TAG_BASE ?= arti.dev.cray.com/nnf-sos
...
kind-push: ## Push docker image to kind
	kind load docker-image --nodes `kubectl get node -l cray.nnf.node=true --no-headers -o custom-columns=":metadata.name" | paste -d, -s -` ${IMG}
