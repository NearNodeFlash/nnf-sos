...
build-daemon1-local: $(LOCALBIN)
build-daemon1-local: fmt vet ## Build standalone clientmount binary
	CGO_ENABLED=0 go build -ldflags="-X '$(PACKAGE).version=$(RPM_VERSION)'" -o bin/mounter1 mounter1/main.go
