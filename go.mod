...
require (
	github.com/DataWorkflowServices/dws v0.0.1-0.20240708161847-9078b37a8c3e
	github.com/NearNodeFlash/lustre-fs-operator v0.0.1-0.20240708161914-7fe5e6ce87a2
