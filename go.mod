...
require (
	github.com/DataWorkflowServices/dws v0.0.1-0.20240912190145-0c426bd1fc01
	github.com/NearNodeFlash/lustre-fs-operator v0.0.1-0.20240905174034-b32f94689b37
