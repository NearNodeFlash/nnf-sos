...
func Convert_v1alpha5_NnfLustreMGTSpec_To_v1alpha2_NnfLustreMGTSpec(in *nnfv1alpha5.NnfLustreMGTSpec, out *NnfLustreMGTSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha5_NnfLustreMGTSpec_To_v1alpha2_NnfLustreMGTSpec(in, out, s)
}

func Convert_v1alpha5_NnfLustreMGTStatus_To_v1alpha2_NnfLustreMGTStatus(in *nnfv1alpha5.NnfLustreMGTStatus, out *NnfLustreMGTStatus, s apiconversion.Scope) error {
	return autoConvert_v1alpha5_NnfLustreMGTStatus_To_v1alpha2_NnfLustreMGTStatus(in, out, s)
}
