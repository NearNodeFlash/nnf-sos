...
// +kubebuilder:webhook:path=/validate-nnf-cray-hpe-com-v1alpha9-nnfdatamovementprofile,mutating=false,failurePolicy=fail,sideEffects=None,groups=nnf.cray.hpe.com,resources=nnfdatamovementprofiles,verbs=create;update,versions=v1alpha9,name=vnnfdatamovementprofile.kb.io,admissionReviewVersions=v1
