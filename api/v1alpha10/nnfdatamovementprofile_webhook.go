...
// +kubebuilder:webhook:path=/validate-nnf-cray-hpe-com-v1alpha10-nnfdatamovementprofile,mutating=false,failurePolicy=fail,sideEffects=None,groups=nnf.cray.hpe.com,resources=nnfdatamovementprofiles,verbs=create;update,versions=v1alpha10,name=vnnfdatamovementprofile.kb.io,admissionReviewVersions=v1
