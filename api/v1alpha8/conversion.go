...
func Convert_v1alpha8_NnfStorageProfileLustreData_To_v1alpha10_NnfStorageProfileLustreData(in *NnfStorageProfileLustreData, out *nnfv1alpha10.NnfStorageProfileLustreData, s apiconversion.Scope) error {
	...
	// Client options
	out.ClientCmdLines.MountRabbit = in.ClientCmdLines.MountRabbit
	out.ClientCmdLines.MountCompute = in.ClientCmdLines.MountCompute
	out.ClientCmdLines.RabbitPostSetup = in.ClientCmdLines.RabbitPostMount
	out.ClientCmdLines.RabbitPreTeardown = in.ClientCmdLines.RabbitPreUnmount
