...
func autoConvert_v1alpha3_ResourceError_To_v1alpha4_ResourceError(in *dwsv1alpha3.ResourceError, out *dwsv1alpha4.ResourceError, s apiconversion.Scope) error {
	out.Error = (*dwsv1alpha4.ResourceErrorInfo)(unsafe.Pointer(in.Error))
	return nil
}

// Convert_v1alpha3_ResourceError_To_v1alpha4_ResourceError is an autogenerated conversion function.
func Convert_v1alpha3_ResourceError_To_v1alpha4_ResourceError(in *dwsv1alpha3.ResourceError, out *dwsv1alpha4.ResourceError, s apiconversion.Scope) error {
	return autoConvert_v1alpha3_ResourceError_To_v1alpha4_ResourceError(in, out, s)
}

func autoConvert_v1alpha4_ResourceError_To_v1alpha3_ResourceError(in *dwsv1alpha4.ResourceError, out *dwsv1alpha3.ResourceError, s apiconversion.Scope) error {
...
func Convert_v1alpha4_ResourceError_To_v1alpha3_ResourceError(in *dwsv1alpha4.ResourceError, out *dwsv1alpha3.ResourceError, s apiconversion.Scope) error {
	return autoConvert_v1alpha4_ResourceError_To_v1alpha3_ResourceError(in, out, s)
}

func autoConvert_v1alpha3_ResourceErrorInfo_To_v1alpha4_ResourceErrorInfo(in *dwsv1alpha3.ResourceErrorInfo, out *dwsv1alpha4.ResourceErrorInfo, s apiconversion.Scope) error {
...
// Convert_v1alpha3_ResourceErrorInfo_To_v1alpha4_ResourceErrorInfo is an autogenerated conversion function.
func Convert_v1alpha3_ResourceErrorInfo_To_v1alpha4_ResourceErrorInfo(in *dwsv1alpha3.ResourceErrorInfo, out *dwsv1alpha4.ResourceErrorInfo, s apiconversion.Scope) error {
	return autoConvert_v1alpha3_ResourceErrorInfo_To_v1alpha4_ResourceErrorInfo(in, out, s)
}

func autoConvert_v1alpha4_ResourceErrorInfo_To_v1alpha3_ResourceErrorInfo(in *dwsv1alpha4.ResourceErrorInfo, out *dwsv1alpha3.ResourceErrorInfo, s apiconversion.Scope) error {
	out.UserMessage = in.UserMessage
	out.DebugMessage = in.DebugMessage
...
// Convert_v1alpha4_ResourceErrorInfo_To_v1alpha3_ResourceErrorInfo is an autogenerated conversion function.
func Convert_v1alpha4_ResourceErrorInfo_To_v1alpha3_ResourceErrorInfo(in *dwsv1alpha4.ResourceErrorInfo, out *dwsv1alpha3.ResourceErrorInfo, s apiconversion.Scope) error {
	return autoConvert_v1alpha4_ResourceErrorInfo_To_v1alpha3_ResourceErrorInfo(in, out, s)
}
...
func Convert_v1alpha6_NnfDataMovementManagerSpec_To_v1alpha7_NnfDataMovementManagerSpec(in *NnfDataMovementManagerSpec, out *nnfv1alpha7.NnfDataMovementManagerSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_NnfDataMovementManagerSpec_To_v1alpha7_NnfDataMovementManagerSpec(in, out, s)
}

func Convert_v1alpha7_NnfDataMovementManagerSpec_To_v1alpha6_NnfDataMovementManagerSpec(in *nnfv1alpha7.NnfDataMovementManagerSpec, out *NnfDataMovementManagerSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha7_NnfDataMovementManagerSpec_To_v1alpha6_NnfDataMovementManagerSpec(in, out, s)
}
