...
func autoConvert_v1alpha4_NnfContainerProfileList_To_v1alpha7_NnfContainerProfileList(in *NnfContainerProfileList, out *v1alpha7.NnfContainerProfileList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]v1alpha7.NnfContainerProfile, len(*in))
		for i := range *in {
			if err := Convert_v1alpha4_NnfContainerProfile_To_v1alpha7_NnfContainerProfile(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha7_NnfContainerProfileList_To_v1alpha4_NnfContainerProfileList(in *v1alpha7.NnfContainerProfileList, out *NnfContainerProfileList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]NnfContainerProfile, len(*in))
		for i := range *in {
			if err := Convert_v1alpha7_NnfContainerProfile_To_v1alpha4_NnfContainerProfile(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
