...
func (src *NnfAccess) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfAccess_To_v1alpha7_NnfAccess(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfAccess) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfAccess_To_v1alpha4_NnfAccess(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfContainerProfile) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfContainerProfile_To_v1alpha7_NnfContainerProfile(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfDataMovement) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfDataMovement_To_v1alpha7_NnfDataMovement(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfDataMovement) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfDataMovement_To_v1alpha4_NnfDataMovement(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfDataMovementManager) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfDataMovementManager_To_v1alpha7_NnfDataMovementManager(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfDataMovementManager) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfDataMovementManager_To_v1alpha4_NnfDataMovementManager(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfDataMovementProfile) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfDataMovementProfile_To_v1alpha7_NnfDataMovementProfile(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfDataMovementProfile) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfDataMovementProfile_To_v1alpha4_NnfDataMovementProfile(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfLustreMGT) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfLustreMGT_To_v1alpha7_NnfLustreMGT(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfLustreMGT) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfLustreMGT_To_v1alpha4_NnfLustreMGT(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfNode) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfNode_To_v1alpha7_NnfNode(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfNode) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfNode_To_v1alpha4_NnfNode(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfNodeBlockStorage) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfNodeBlockStorage_To_v1alpha7_NnfNodeBlockStorage(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfNodeBlockStorage) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfNodeBlockStorage_To_v1alpha4_NnfNodeBlockStorage(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfNodeECData) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfNodeECData_To_v1alpha7_NnfNodeECData(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfNodeECData) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfNodeECData_To_v1alpha4_NnfNodeECData(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfNodeStorage) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfNodeStorage_To_v1alpha7_NnfNodeStorage(src, dst, nil); err != nil {
		return err
	}
	...
	// Otherwise, you may comment out UnmarshalData() until it's needed.
	if hasAnno {
		dst.Spec.CommandVariables = make([]nnfv1alpha7.CommandVariablesSpec, len(restored.Spec.CommandVariables))
...
func (dst *NnfNodeStorage) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfNodeStorage_To_v1alpha4_NnfNodeStorage(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfPortManager) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfPortManager_To_v1alpha7_NnfPortManager(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfPortManager) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfPortManager_To_v1alpha4_NnfPortManager(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfStorage) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfStorage_To_v1alpha7_NnfStorage(src, dst, nil); err != nil {
		return err
	}
	...
	if hasAnno {
		for i := range restored.Spec.AllocationSets {
			dst.Spec.AllocationSets[i].CommandVariables = make([]nnfv1alpha7.CommandVariablesSpec, len(restored.Spec.AllocationSets[i].CommandVariables))
...
func (dst *NnfStorage) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfStorage_To_v1alpha4_NnfStorage(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfStorageProfile) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfStorageProfile_To_v1alpha7_NnfStorageProfile(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfStorageProfile) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfStorageProfile_To_v1alpha4_NnfStorageProfile(src, dst, nil); err != nil {
		return err
	}
...
func (src *NnfSystemStorage) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha4_NnfSystemStorage_To_v1alpha7_NnfSystemStorage(src, dst, nil); err != nil {
		return err
	}
...
func (dst *NnfSystemStorage) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha7_NnfSystemStorage_To_v1alpha4_NnfSystemStorage(src, dst, nil); err != nil {
		return err
	}
...
func Convert_v1alpha7_NnfNodeStorageSpec_To_v1alpha4_NnfNodeStorageSpec(in *nnfv1alpha7.NnfNodeStorageSpec, out *NnfNodeStorageSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha7_NnfNodeStorageSpec_To_v1alpha4_NnfNodeStorageSpec(in, out, s)
}

func Convert_v1alpha7_NnfStorageAllocationSetSpec_To_v1alpha4_NnfStorageAllocationSetSpec(in *nnfv1alpha7.NnfStorageAllocationSetSpec, out *NnfStorageAllocationSetSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha7_NnfStorageAllocationSetSpec_To_v1alpha4_NnfStorageAllocationSetSpec(in, out, s)
}

func Convert_v1alpha7_NnfLustreMGTSpec_To_v1alpha4_NnfLustreMGTSpec(in *nnfv1alpha7.NnfLustreMGTSpec, out *NnfLustreMGTSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha7_NnfLustreMGTSpec_To_v1alpha4_NnfLustreMGTSpec(in, out, s)
}

func Convert_v1alpha7_NnfLustreMGTStatus_To_v1alpha4_NnfLustreMGTStatus(in *nnfv1alpha7.NnfLustreMGTStatus, out *NnfLustreMGTStatus, s apiconversion.Scope) error {
	return autoConvert_v1alpha7_NnfLustreMGTStatus_To_v1alpha4_NnfLustreMGTStatus(in, out, s)
}

func Convert_v1alpha7_NnfStorageProfileLustreData_To_v1alpha4_NnfStorageProfileLustreData(in *nnfv1alpha7.NnfStorageProfileLustreData, out *NnfStorageProfileLustreData, s apiconversion.Scope) error {
	return autoConvert_v1alpha7_NnfStorageProfileLustreData_To_v1alpha4_NnfStorageProfileLustreData(in, out, s)
}

func Convert_v1alpha4_NnfStorageProfileLustreData_To_v1alpha7_NnfStorageProfileLustreData(in *NnfStorageProfileLustreData, out *nnfv1alpha7.NnfStorageProfileLustreData, s apiconversion.Scope) error {
	return autoConvert_v1alpha4_NnfStorageProfileLustreData_To_v1alpha7_NnfStorageProfileLustreData(in, out, s)
}

func Convert_v1alpha4_NnfStorageProfileLustreCmdLines_To_v1alpha7_NnfStorageProfileLustreCmdLines(in *NnfStorageProfileLustreCmdLines, out *nnfv1alpha7.NnfStorageProfileLustreCmdLines, s apiconversion.Scope) error {
	return autoConvert_v1alpha4_NnfStorageProfileLustreCmdLines_To_v1alpha7_NnfStorageProfileLustreCmdLines(in, out, s)
}
