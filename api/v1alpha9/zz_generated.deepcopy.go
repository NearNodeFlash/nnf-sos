...
func (in *NnfStorageProfileLustreData) DeepCopyInto(out *NnfStorageProfileLustreData) {
	*out = *in
	in.MgtCmdLines.DeepCopyInto(&out.MgtCmdLines)
	in.MdtCmdLines.DeepCopyInto(&out.MdtCmdLines)
	in.MgtMdtCmdLines.DeepCopyInto(&out.MgtMdtCmdLines)
	in.OstCmdLines.DeepCopyInto(&out.OstCmdLines)
	...
	if in.PreMountMGTCmds != nil {
		in, out := &in.PreMountMGTCmds, &out.PreMountMGTCmds
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
