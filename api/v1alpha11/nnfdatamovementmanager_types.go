...
type NnfDataMovementManagerStatus struct {
	...
	// conditions represent the current state of the NnfDataMovementManager resource.
...
type NnfDataMovementManager struct {
	...
	// spec defines the desired state of NnfDataMovementManager
	// +required
	Spec NnfDataMovementManagerSpec `json:"spec"`

	// status defines the observed state of NnfDataMovementManager
	// +optional
	Status NnfDataMovementManagerStatus `json:"status,omitzero"`
}
