...
type NnfContainerProfileSpec struct {
	...
	// foo is an example field of NnfContainerProfile. Edit nnfcontainerprofile_types.go to remove/update
	// +optional
...
type NnfContainerProfileStatus struct {
	...
	// conditions represent the current state of the NnfContainerProfile resource.
...
type NnfContainerProfile struct {
	...
	// spec defines the desired state of NnfContainerProfile
	// +required
	Spec NnfContainerProfileSpec `json:"spec"`

	// status defines the observed state of NnfContainerProfile
	// +optional
	Status NnfContainerProfileStatus `json:"status,omitzero"`
}
