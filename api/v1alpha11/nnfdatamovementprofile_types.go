...
type NnfDataMovementProfileStatus struct {
	...
	// conditions represent the current state of the NnfDataMovementProfile resource.
...
type NnfDataMovementProfile struct {
	...
	// spec defines the desired state of NnfDataMovementProfile
	// +required
	Spec NnfDataMovementProfileSpec `json:"spec"`

	// status defines the observed state of NnfDataMovementProfile
	// +optional
	Status NnfDataMovementProfileStatus `json:"status,omitzero"`
}
