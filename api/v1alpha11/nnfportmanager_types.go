...
type NnfPortManagerSpec struct {
	...
	// foo is an example field of NnfPortManager. Edit nnfportmanager_types.go to remove/update
	// +optional
...
type NnfPortManagerStatus struct {
	...
	// conditions represent the current state of the NnfPortManager resource.
...
type NnfPortManager struct {
	...
	// spec defines the desired state of NnfPortManager
	// +required
	Spec NnfPortManagerSpec `json:"spec"`

	// status defines the observed state of NnfPortManager
	// +optional
	Status NnfPortManagerStatus `json:"status,omitzero"`
}
