...
type NnfDataMovementSpec struct {
	...
	// foo is an example field of NnfDataMovement. Edit nnfdatamovement_types.go to remove/update
	// +optional
...
type NnfDataMovementStatus struct {
	...
	// conditions represent the current state of the NnfDataMovement resource.
...
type NnfDataMovement struct {
	...
	// spec defines the desired state of NnfDataMovement
	// +required
	Spec NnfDataMovementSpec `json:"spec"`

	// status defines the observed state of NnfDataMovement
	// +optional
	Status NnfDataMovementStatus `json:"status,omitzero"`
}
