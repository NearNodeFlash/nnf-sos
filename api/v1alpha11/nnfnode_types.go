...
type NnfNodeStatus struct {
	...
	// conditions represent the current state of the NnfNode resource.
...
type NnfNode struct {
	...
	// spec defines the desired state of NnfNode
	// +required
	Spec NnfNodeSpec `json:"spec"`

	// status defines the observed state of NnfNode
	// +optional
	Status NnfNodeStatus `json:"status,omitzero"`
}
