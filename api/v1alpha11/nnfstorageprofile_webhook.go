...
//+kubebuilder:webhook:path=/validate-nnf-cray-hpe-com-v1alpha11-nnfstorageprofile,mutating=false,failurePolicy=fail,sideEffects=None,groups=nnf.cray.hpe.com,resources=nnfstorageprofiles,verbs=create;update,versions=v1alpha11,name=vnnfstorageprofile.kb.io,admissionReviewVersions=v1
