...
type NnfStorageStatus struct {
	...
	// conditions represent the current state of the NnfStorage resource.
...
type NnfStorage struct {
	...
	// spec defines the desired state of NnfStorage
	// +required
	Spec NnfStorageSpec `json:"spec"`

	// status defines the observed state of NnfStorage
	// +optional
	Status NnfStorageStatus `json:"status,omitzero"`
}
