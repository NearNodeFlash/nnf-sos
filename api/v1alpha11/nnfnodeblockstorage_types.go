...
type NnfNodeBlockStorageStatus struct {
	...
	// conditions represent the current state of the NnfNodeBlockStorage resource.
...
type NnfNodeBlockStorage struct {
	...
	// spec defines the desired state of NnfNodeBlockStorage
	// +required
	Spec NnfNodeBlockStorageSpec `json:"spec"`

	// status defines the observed state of NnfNodeBlockStorage
	// +optional
	Status NnfNodeBlockStorageStatus `json:"status,omitzero"`
}
