...
type NnfSystemStorageStatus struct {
	...
	// conditions represent the current state of the NnfSystemStorage resource.
...
type NnfSystemStorage struct {
	...
	// spec defines the desired state of NnfSystemStorage
	// +required
	Spec NnfSystemStorageSpec `json:"spec"`

	// status defines the observed state of NnfSystemStorage
	// +optional
	Status NnfSystemStorageStatus `json:"status,omitzero"`
}
