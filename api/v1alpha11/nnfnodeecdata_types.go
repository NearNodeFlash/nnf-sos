...
type NnfNodeECDataStatus struct {
	...
	// conditions represent the current state of the NnfNodeECData resource.
...
type NnfNodeECData struct {
	...
	// spec defines the desired state of NnfNodeECData
	// +required
	Spec NnfNodeECDataSpec `json:"spec"`

	// status defines the observed state of NnfNodeECData
	// +optional
	Status NnfNodeECDataStatus `json:"status,omitzero"`
}
