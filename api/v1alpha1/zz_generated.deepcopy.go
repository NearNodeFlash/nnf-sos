...
func (in *NnfStorageProfileData) DeepCopyInto(out *NnfStorageProfileData) {
	*out = *in
	if in.LustreStorage != nil {
		in, out := &in.LustreStorage, &out.LustreStorage
		*out = new(NnfStorageProfileLustreData)
		(*in).DeepCopyInto(*out)
	}
	if in.GFS2Storage != nil {
		in, out := &in.GFS2Storage, &out.GFS2Storage
		*out = new(NnfStorageProfileGFS2Data)
		**out = **in
	}
	if in.XFSStorage != nil {
		in, out := &in.XFSStorage, &out.XFSStorage
		*out = new(NnfStorageProfileXFSData)
		**out = **in
	}
	if in.RawStorage != nil {
		in, out := &in.RawStorage, &out.RawStorage
...
func (in *NnfStorageProfileLustreData) DeepCopyInto(out *NnfStorageProfileLustreData) {
	*out = *in
	if in.ExternalMGS != nil {
		in, out := &in.ExternalMGS, &out.ExternalMGS
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
