...
// +kubebuilder:webhook:path=/validate-nnf-cray-hpe-com-v1alpha4-nnfdatamovementprofile,mutating=false,failurePolicy=fail,sideEffects=None,groups=nnf.cray.hpe.com,resources=nnfdatamovementprofiles,verbs=create;update,versions=v1alpha4,name=vnnfdatamovementprofile.kb.io,admissionReviewVersions=v1
