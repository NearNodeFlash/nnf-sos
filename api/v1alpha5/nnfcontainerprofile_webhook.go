...
//+kubebuilder:webhook:path=/validate-nnf-cray-hpe-com-v1alpha4-nnfcontainerprofile,mutating=false,failurePolicy=fail,sideEffects=None,groups=nnf.cray.hpe.com,resources=nnfcontainerprofiles,verbs=create;update,versions=v1alpha4,name=vnnfcontainerprofile.kb.io,admissionReviewVersions=v1
