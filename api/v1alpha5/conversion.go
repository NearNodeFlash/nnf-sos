...
func autoConvert_v1alpha2_ResourceError_To_v1alpha5_ResourceError(in *dwsv1alpha2.ResourceError, out *dwsv1alpha5.ResourceError, s apiconversion.Scope) error {
...
func Convert_v1alpha2_ResourceError_To_v1alpha5_ResourceError(in *dwsv1alpha2.ResourceError, out *dwsv1alpha5.ResourceError, s apiconversion.Scope) error {
	return autoConvert_v1alpha2_ResourceError_To_v1alpha5_ResourceError(in, out, s)
}

func autoConvert_v1alpha5_ResourceError_To_v1alpha2_ResourceError(in *dwsv1alpha5.ResourceError, out *dwsv1alpha2.ResourceError, s apiconversion.Scope) error {
...
func Convert_v1alpha5_ResourceError_To_v1alpha2_ResourceError(in *dwsv1alpha5.ResourceError, out *dwsv1alpha2.ResourceError, s apiconversion.Scope) error {
	return autoConvert_v1alpha5_ResourceError_To_v1alpha2_ResourceError(in, out, s)
}

func autoConvert_v1alpha2_ResourceErrorInfo_To_v1alpha5_ResourceErrorInfo(in *dwsv1alpha2.ResourceErrorInfo, out *dwsv1alpha5.ResourceErrorInfo, s apiconversion.Scope) error {
...
func Convert_v1alpha2_ResourceErrorInfo_To_v1alpha5_ResourceErrorInfo(in *dwsv1alpha2.ResourceErrorInfo, out *dwsv1alpha5.ResourceErrorInfo, s apiconversion.Scope) error {
	return autoConvert_v1alpha2_ResourceErrorInfo_To_v1alpha5_ResourceErrorInfo(in, out, s)
}

func autoConvert_v1alpha5_ResourceErrorInfo_To_v1alpha2_ResourceErrorInfo(in *dwsv1alpha5.ResourceErrorInfo, out *dwsv1alpha2.ResourceErrorInfo, s apiconversion.Scope) error {
	out.UserMessage = in.UserMessage
	out.DebugMessage = in.DebugMessage
...
func Convert_v1alpha5_ResourceErrorInfo_To_v1alpha2_ResourceErrorInfo(in *dwsv1alpha5.ResourceErrorInfo, out *dwsv1alpha2.ResourceErrorInfo, s apiconversion.Scope) error {
