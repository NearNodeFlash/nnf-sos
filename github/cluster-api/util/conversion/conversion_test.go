...
var (
	oldNnfAccessGVK = schema.GroupVersionKind{
		Group:   nnfv1alpha4.GroupVersion.Group,
		Version: "v1old",
		Kind:    "NnfAccess",
	}
...
func TestMarshalData(t *testing.T) {
	...
	t.Run("NnfAccess should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfAccess"))
		dst.SetName("test-1")
	...
	t.Run("NnfContainerProfile should write source object to destination", func(*testing.T) {
		...
		userid := uint32(7667)
		groupid := uint32(8448)
		src := &nnfv1alpha4.NnfContainerProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Data: nnfv1alpha4.NnfContainerProfileData{
	...
	t.Run("NnfContainerProfile should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfContainerProfile"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfDataMovement should write source object to destination", func(*testing.T) {
		destpath := &nnfv1alpha4.NnfDataMovementSpecSourceDestination{
			Path: "little/red",
		}
		srcpath := &nnfv1alpha4.NnfDataMovementSpecSourceDestination{
			Path: "/dev/null",
		}
		src := &nnfv1alpha4.NnfDataMovement{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfDataMovement should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfDataMovement"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfDataMovementManager should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha4.NnfDataMovementManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfDataMovementManager should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfDataMovementManager"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfDataMovementProfile should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha4.NnfDataMovementProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfDataMovementProfile should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfDataMovementProfile"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfLustreMGT should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfLustreMGT"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNode should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfNode"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNodeBlockStorage should write source object to destination", func(*testing.T) {
		alloc := []nnfv1alpha4.NnfNodeBlockStorageAllocationSpec{
			{Access: []string{"rabbit-44", "rabbit-10002"}},
		}
		src := &nnfv1alpha4.NnfNodeBlockStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Spec: nnfv1alpha4.NnfNodeBlockStorageSpec{
				Allocations: alloc,
			},
		}
	...
	t.Run("NnfNodeBlockStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfNodeBlockStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNodeECData should write source object to destination", func(*testing.T) {
		elem1 := nnfv1alpha4.NnfNodeECPrivateData{"element1": "the world"}
		priv := map[string]nnfv1alpha4.NnfNodeECPrivateData{
			"thing1": elem1,
		}
		src := &nnfv1alpha4.NnfNodeECData{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Status: nnfv1alpha4.NnfNodeECDataStatus{
				Data: priv,
			},
		}
	...
	t.Run("NnfNodeECData should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfNodeECData"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNodeStorage should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha4.NnfNodeStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Spec: nnfv1alpha4.NnfNodeStorageSpec{
				UserID:         4997,
				GroupID:        2112,
				FileSystemType: "gfs2",
			},
	...
	t.Run("NnfNodeStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfNodeStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfPortManager should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha4.NnfPortManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Spec: nnfv1alpha4.NnfPortManagerSpec{
	...
	t.Run("NnfPortManager should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfPortManager"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfStorageProfile should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha4.NnfStorageProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Data: nnfv1alpha4.NnfStorageProfileData{
				LustreStorage: nnfv1alpha4.NnfStorageProfileLustreData{
	...
	t.Run("NnfSystemStorage should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha4.NnfSystemStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Spec: nnfv1alpha4.NnfSystemStorageSpec{
	...
	t.Run("NnfSystemStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha4.GroupVersion.WithKind("NnfSystemStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
...
func TestUnmarshalData(t *testing.T) {
	...
	t.Run("NnfContainerProfile should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfContainerProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfDataMovement should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfDataMovement{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfDataMovementManager should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfDataMovementManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfDataMovementProfile should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfDataMovementProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfNodeBlockStorage should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfNodeBlockStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfNodeStorage should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfNodeStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfPortManager should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfPortManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfStorageProfile should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfStorageProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfSystemStorage should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha4.NnfSystemStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
