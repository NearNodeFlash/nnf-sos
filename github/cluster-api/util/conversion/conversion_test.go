...
var (
	oldNnfAccessGVK = schema.GroupVersionKind{
		Group:   nnfv1alpha10.GroupVersion.Group,
		Version: "v1old",
		Kind:    "NnfAccess",
	}
...
func TestMarshalData(t *testing.T) {
	...
	t.Run("NnfAccess should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfAccess"))
		dst.SetName("test-1")
	...
	t.Run("NnfContainerProfile should write source object to destination", func(*testing.T) {
		...
		userid := uint32(7667)
		groupid := uint32(8448)
		src := &nnfv1alpha10.NnfContainerProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfContainerProfile should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfContainerProfile"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfDataMovement should write source object to destination", func(*testing.T) {
		destpath := &nnfv1alpha10.NnfDataMovementSpecSourceDestination{
			Path: "little/red",
		}
		srcpath := &nnfv1alpha10.NnfDataMovementSpecSourceDestination{
			Path: "/dev/null",
		}
		src := &nnfv1alpha10.NnfDataMovement{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfDataMovement should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfDataMovement"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfDataMovementManager should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha10.NnfDataMovementManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfDataMovementManager should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfDataMovementManager"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfDataMovementProfile should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha10.NnfDataMovementProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfDataMovementProfile should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfDataMovementProfile"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfLustreMGT should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfLustreMGT"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNode should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfNode"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNodeBlockStorage should write source object to destination", func(*testing.T) {
		alloc := []nnfv1alpha10.NnfNodeBlockStorageAllocationSpec{
			{Access: []string{"rabbit-44", "rabbit-10002"}},
		}
		src := &nnfv1alpha10.NnfNodeBlockStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfNodeBlockStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfNodeBlockStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNodeECData should write source object to destination", func(*testing.T) {
		elem1 := nnfv1alpha10.NnfNodeECPrivateData{"element1": "the world"}
		priv := map[string]nnfv1alpha10.NnfNodeECPrivateData{
			"thing1": elem1,
		}
		src := &nnfv1alpha10.NnfNodeECData{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
			...
			Status: nnfv1alpha10.NnfNodeECDataStatus{
				Data: priv,
			},
		}
	...
	t.Run("NnfNodeECData should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfNodeECData"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfNodeStorage should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha10.NnfNodeStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfNodeStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfNodeStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfPortManager should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha10.NnfPortManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfPortManager should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfPortManager"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfStorageProfile should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha10.NnfStorageProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfStorageProfile should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfStorageProfile"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
	...
	t.Run("NnfSystemStorage should write source object to destination", func(*testing.T) {
		src := &nnfv1alpha10.NnfSystemStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
				Labels: map[string]string{
					"label1": "",
	...
	t.Run("NnfSystemStorage should append the annotation", func(*testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(nnfv1alpha10.GroupVersion.WithKind("NnfSystemStorage"))
		dst.SetName("test-1")
		dst.SetAnnotations(map[string]string{
			"annotation": "1",
		})
...
func TestUnmarshalData(t *testing.T) {
	...
	t.Run("NnfContainerProfile should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfContainerProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfDataMovement should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfDataMovement{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfDataMovementManager should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfDataMovementManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfDataMovementProfile should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfDataMovementProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfNodeBlockStorage should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfNodeBlockStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfNodeECData should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfNodeECData{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfNodeStorage should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfNodeStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfPortManager should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfPortManager{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfStorageProfile should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfStorageProfile{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
	...
	t.Run("NnfSystemStorage should return true when a valid annotation with data exists", func(*testing.T) {
		...
		dst := &nnfv1alpha10.NnfSystemStorage{
			ObjectMeta: metav1.ObjectMeta{
				Name: "test-1",
			},
		}
