...
func (r *NnfNodeStorageReconciler) formatFileSystem(ctx context.Context, nodeStorage *nnfv1alpha1.NnfNodeStorage, index int) (*ctrl.Result, error) {
	...
	var addOpts *nnfv1alpha1.NnfStorageProfileMiscData = nil
	if oem.Type == "lustre" {
		...
		case "MGT":
			addOpts = &nnfStorageProfile.Data.LustreStorage.MgtOptions
		case "MDT", "MGTMDT":
			addOpts = &nnfStorageProfile.Data.LustreStorage.MdtOptions
		case "OST":
			addOpts = &nnfStorageProfile.Data.LustreStorage.OstOptions
		}
	}
	...
	if oem.Type == "gfs2" {
		...
		addOpts = &nnfStorageProfile.Data.GFS2Storage.Options
	}

	if oem.Type == "xfs" {
		addOpts = &nnfStorageProfile.Data.XFSStorage.Options
	}

	if oem.Type == "lvm" {
		addOpts = &nnfStorageProfile.Data.RawStorage.Options
	}

	if addOpts != nil {
		oem.MkfsMountAddOpts.Mkfs = addOpts.AddMkfs
		oem.MkfsMountAddOpts.Mount = addOpts.AddMount
		oem.LvmAddOpts.PvCreate = addOpts.AddPvCreate
		oem.LvmAddOpts.VgCreate = addOpts.AddVgCreate
		oem.LvmAddOpts.LvCreate = addOpts.AddLvCreate
	}
