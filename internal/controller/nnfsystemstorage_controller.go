...
func (r *NnfSystemStorageReconciler) getSystemConfiguration(ctx context.Context, nnfSystemStorage *nnfv1alpha8.NnfSystemStorage) (*dwsv1alpha5.SystemConfiguration, error) {
...
func (r *NnfSystemStorageReconciler) getStorageProfile(ctx context.Context, nnfSystemStorage *nnfv1alpha8.NnfSystemStorage) (*nnfv1alpha8.NnfStorageProfile, error) {
	...
	if nnfSystemStorage.Spec.StorageProfile.Kind != reflect.TypeOf(nnfv1alpha8.NnfStorageProfile{}).Name() {
		return nil, dwsv1alpha5.NewResourceError("StorageProfile is not of kind '%s'", reflect.TypeOf(nnfv1alpha8.NnfStorageProfile{}).Name()).WithFatal()
	}
