...
func (r *NnfSystemStorageReconciler) getSystemConfiguration(ctx context.Context, nnfSystemStorage *nnfv1alpha9.NnfSystemStorage) (*dwsv1alpha6.SystemConfiguration, error) {
...
func (r *NnfSystemStorageReconciler) getStorageProfile(ctx context.Context, nnfSystemStorage *nnfv1alpha9.NnfSystemStorage) (*nnfv1alpha9.NnfStorageProfile, error) {
	...
	if nnfSystemStorage.Spec.StorageProfile.Kind != reflect.TypeOf(nnfv1alpha9.NnfStorageProfile{}).Name() {
		return nil, dwsv1alpha6.NewResourceError("StorageProfile is not of kind '%s'", reflect.TypeOf(nnfv1alpha9.NnfStorageProfile{}).Name()).WithFatal()
	}
