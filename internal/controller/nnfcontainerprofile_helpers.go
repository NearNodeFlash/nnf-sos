...
func getContainerProfile(ctx context.Context, clnt client.Client, workflow *dwsv1alpha6.Workflow, index int) (*nnfv1alpha9.NnfContainerProfile, error) {
...
func findPinnedContainerProfile(ctx context.Context, clnt client.Client, workflow *dwsv1alpha6.Workflow, index int) (*nnfv1alpha9.NnfContainerProfile, error) {
...
func findContainerProfile(ctx context.Context, clnt client.Client, workflow *dwsv1alpha6.Workflow, index int) (*nnfv1alpha9.NnfContainerProfile, error) {
