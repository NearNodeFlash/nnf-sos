...
func getContainerProfile(ctx context.Context, clnt client.Client, workflow *dwsv1alpha5.Workflow, index int) (*nnfv1alpha8.NnfContainerProfile, error) {
...
func findPinnedContainerProfile(ctx context.Context, clnt client.Client, workflow *dwsv1alpha5.Workflow, index int) (*nnfv1alpha8.NnfContainerProfile, error) {
...
func findContainerProfile(ctx context.Context, clnt client.Client, workflow *dwsv1alpha5.Workflow, index int) (*nnfv1alpha8.NnfContainerProfile, error) {
