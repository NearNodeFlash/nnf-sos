...
func (r *NnfLustreMGTReconciler) Reconcile(ctx context.Context, req ctrl.Request) (res ctrl.Result, err error) {
	...
	statusUpdater := updater.NewStatusUpdater[*nnfv1alpha1.NnfLustreMGTStatus](nnfLustreMgt)
...
// an fsname
func (r *NnfLustreMGTReconciler) HandleNewClaims(ctx context.Context, nnfLustreMgt *nnfv1alpha1.NnfLustreMGT) (*ctrl.Result, error) {
	...
	for _, reference := range nnfLustreMgt.Spec.ClaimList {
		if _, exists := claimMap[reference]; !exists {
			...
			newClaim := nnfv1alpha1.NnfLustreMGTStatusClaim{
				Reference: reference,
				FsName:    fsnameNext,
			}
...
func (r *NnfLustreMGTReconciler) RemoveOldClaims(ctx context.Context, nnfLustreMgt *nnfv1alpha1.NnfLustreMGT) error {
