...
func (r *NnfLustreMGTReconciler) Reconcile(ctx context.Context, req ctrl.Request) (res ctrl.Result, err error) {
	...
	statusUpdater := updater.NewStatusUpdater[*nnfv1alpha11.NnfLustreMGTStatus](nnfLustreMgt)
...
func isFsNameBlackListed(nnfLustreMgt *nnfv1alpha11.NnfLustreMGT, fsname string) bool {
	// Check the blacklist
...
func (r *NnfLustreMGTReconciler) SetFsNameNext(ctx context.Context, nnfLustreMgt *nnfv1alpha11.NnfLustreMGT, fsname string) (*ctrl.Result, error) {
...
// an fsname
func (r *NnfLustreMGTReconciler) HandleNewClaims(ctx context.Context, nnfLustreMgt *nnfv1alpha11.NnfLustreMGT) (*ctrl.Result, error) {
	...
	for _, reference := range nnfLustreMgt.Spec.ClaimList {
		if _, exists := claimMap[reference]; !exists {
			...
			newClaim := nnfv1alpha11.NnfLustreMGTStatusClaim{
				Reference: reference,
				FsName:    fsnameNext,
			}
...
func (r *NnfLustreMGTReconciler) RemoveOldClaims(ctx context.Context, nnfLustreMgt *nnfv1alpha11.NnfLustreMGT) error {
...
func (r *NnfLustreMGTReconciler) EraseOldFsName(nnfLustreMgt *nnfv1alpha11.NnfLustreMGT, fsname string) error {
...
func (r *NnfLustreMGTReconciler) HandleNewCommands(ctx context.Context, nnfLustreMgt *nnfv1alpha11.NnfLustreMGT) (*ctrl.Result, error) {
	commandMap := map[corev1.ObjectReference]*nnfv1alpha11.NnfLustreMGTStatusCommand{}
	...
	for _, command := range nnfLustreMgt.Spec.CommandList {
		if commandStatus, exists := commandMap[command.Reference]; !exists || !commandStatus.Ready {
			...
			if !exists {
				commandStatus = &nnfv1alpha11.NnfLustreMGTStatusCommand{
...
func (r *NnfLustreMGTReconciler) RemoveOldCommands(ctx context.Context, nnfLustreMgt *nnfv1alpha11.NnfLustreMGT) error {
...
func (r *NnfLustreMGTReconciler) RunCommands(nnfLustreMgt *nnfv1alpha11.NnfLustreMGT, commandLines []string) error {
	log := r.Log.WithValues("NnfLustreMGT", client.ObjectKeyFromObject(nnfLustreMgt))
	if r.ControllerType != ControllerRabbit {
		return nil
	}
