...
func getPinnedStorageProfileFromLabel(ctx context.Context, clnt client.Client, object metav1.Object) (*nnfv1alpha6.NnfStorageProfile, error) {
	...
	if !okName {
		return nil, dwsv1alpha2.NewResourceError("unable to find %s label", nnfv1alpha6.PinnedStorageProfileLabelName).WithFatal()
	}
	pinnedNamespace, okNamespace := labels[nnfv1alpha6.PinnedStorageProfileLabelNameSpace]
	if !okNamespace {
		return nil, dwsv1alpha2.NewResourceError("unable to find %s label", nnfv1alpha6.PinnedStorageProfileLabelNameSpace).WithFatal()
	}
