...
func (r *NnfPortManagerReconciler) findFreePorts(log logr.Logger, mgr *nnfv1alpha4.NnfPortManager, config *dwsv1alpha3.SystemConfiguration, spec AllocationSpec) ([]uint16, nnfv1alpha4.NnfPortManagerAllocationStatusStatus) {
