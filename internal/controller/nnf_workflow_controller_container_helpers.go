...
func (c *nnfUserContainer) createMPIJob() error {
	...
	// Add host ports for only the launcher spec's containers
...
// divisible by the number of containers, an error is returned.
...
// addHostPorts adds HostPort entries to all containers in a PodSpec using the portMap generated by
...
// NNF_CONTAINER_PORTS_my_container1_- ports assigned to container named my_container1
