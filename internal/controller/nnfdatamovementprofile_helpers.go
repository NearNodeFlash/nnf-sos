...
func findDMProfileToUse(ctx context.Context, clnt client.Client, args map[string]string) (*nnfv1alpha1.NnfDataMovementProfile, error) {
	var profileName string

	NnfDataMovementProfile := &nnfv1alpha1.NnfDataMovementProfile{}
...
func findPinnedDMProfile(ctx context.Context, clnt client.Client, namespace string, pinnedName string) (*nnfv1alpha1.NnfDataMovementProfile, error) {
...
func createPinnedDMProfile(ctx context.Context, clnt client.Client, clntScheme *runtime.Scheme, args map[string]string, owner metav1.Object, pinnedName string) (*nnfv1alpha1.NnfDataMovementProfile, error) {
